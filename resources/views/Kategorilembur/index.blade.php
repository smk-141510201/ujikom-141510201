...
<div class="container-fluid">
	...
	<br>
	<a href="{{ url('/Kategorilembur/create')}}" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i>&nbsp;Tambah Data</a>
<br>
<br>
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td><center><a href="{{ route('Kategorilembur.edit', $data->id)}}" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a></center></td>
			<td><center>
